...
- **2026-07-20 — Polimento de autoria:** `when_to_use` (consolidado na `description` em 2026-08-08) reforça a fronteira (vanilla vs. React vs. decisor); +checklist de Verificação com **evidência** (RLS com 2 contas, config-guard, XSS, PWA). Convenções, os 5 padrões, o exemplo e o ponteiro de referência preservados.
