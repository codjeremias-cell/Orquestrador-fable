...
1. **Visão e mockup (RO-06).** Carregue a skill `designer-ux-ui` (ferramenta Skill — invoque, não descreva): alinhar as telas principais e apresentar o mockup do app com os estados da UI; obter aceite antes de qualquer código.
...
### 📜 Histórico
- **2026-09-24 — Invocação formal de designer-ux-ui no passo 1 (RO-06):** O passo 1 (Visão e mockup) agora carrega formalmente a lente designer-ux-ui pela ferramenta Skill (invoque, não descreva) para alinhamento e mockup antes do código. Modificadores de obrigatoriedade auditados (PADRÃO §12): N = 0.
