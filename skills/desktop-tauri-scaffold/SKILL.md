...
- **2026-07-20 — Polimento de autoria:** `when_to_use` (consolidado na `description` em 2026-08-08) + `argument-hint`; +checklist de Verificação consolidando dev/build verdes, CSP estrita, default-deny e a bridge tipada `ping`. Trava do scaffolder, convenções e few-shot preservados.
