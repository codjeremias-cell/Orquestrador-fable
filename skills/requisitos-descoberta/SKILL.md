...
4. **A fronteira vazia é condição necessária, não suficiente:** todo ramo visitado e nada assumido em silêncio. O fechamento ainda passa pela saturação declarada (RO-15) e pelo "ok" do Jeremias no escopo.
