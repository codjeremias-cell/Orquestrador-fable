...
3. **Estruture a tela (lo-fi):** hierarquia da informação e layout, já listando **todos os estados** (mín. vazio/carregando/erro — ver Postura). Para páginas web e landing pages, diversifique a forma através das **21 Macroestruturas de UI** em [referencia/hallmark/macroestruturas-ui.md](referencia/hallmark/macroestruturas-ui.md) (regra: nunca repetir a macroestrutura da tela anterior).
...
- [ ] **Teste anti-AI slop:** não dá para adivinhar tema+paleta pela categoria (1ª ordem) nem estética pela categoria+anti-referência (2ª ordem) — ver catálogo Impeccable e os **58 Gates Slop-Test** em [referencia/hallmark/slop-test-58-gates.md](referencia/hallmark/slop-test-58-gates.md).
...
### 📜 Histórico
- **2026-08-27 — Microinterações físicas de UI e refinamento tátil (garimpo jakubkrehel 2026-08-27 · JK1; degrau §6.10: 1 — só edição).** Adiciona à `referencia/impeccable-leis-e-proibicoes.md` as leis de microinteração física (raio concêntrico R_outer = R_inner + padding, números tabulares para zerar layout shift, feedback tátil active:scale-[0.96], stroke ótico de ícone proporcional ao peso do texto e banimento de transition: all). Proveniência: `skills/make-interfaces-feel-better/SKILL.md` de `github.com/jakubkrehel/make-interfaces-feel-better` (MIT) — laudo em `garimpo-lote-9-fontes-2026-08-27.md`. Modificadores de obrigatoriedade auditados (PADRÃO §12): N = 0.
- **2026-08-27 — Anti-Slop de sombras e hairlines de superfície (garimpo taste-skill 2026-08-27 · TS1; degrau §6.10: 1 — só edição).** Adiciona à `referencia/impeccable-leis-e-proibicoes.md` o banimento de sombras duras cruas descalibradas e bordas cinzas sólidas genéricas, prescrevendo hairlines translúcidas calibradas (`border-white/10` em dark mode ou OKLCH neutro tingido). Proveniência: `skills/taste-skill/SKILL.md` de `github.com/leonxlnx/taste-skill` (MIT) — laudo em `garimpo-lote-7-repositorios-2026-08-27.md`. Modificadores de obrigatoriedade auditados (PADRÃO §12): N = 0.
- **2026-08-26 — 21 Macroestruturas de UI, 58 Gates Slop-Test e Cookbook de Componentes (garimpo lote-5repos 2026-08-26 · G4–G7; degraus §6.10: 1 e 2).** Adiciona a pasta `referencia/hallmark/` com as 21 macroestruturas de layout (combate ao template repetitivo de IA Hero→3 cards→CTA→Footer), o checklist de 58 gates de slop-test com autoavaliação pré-emissão em 6 eixos, os arquétipos de navegação N1–N13 e rodapés Ft1–Ft8, e o método de extração de DNA visual (Study). No corpo: ponteiros no passo 3 do Como operar e no Checklist final. Proveniência: `nutlope/hallmark` de `github.com/nutlope/hallmark` (Together AI, MIT) — laudo em `garimpo-lote-5repos-2026-08-26.md`. Modificadores de obrigatoriedade auditados (PADRÃO §12): N = 0.
